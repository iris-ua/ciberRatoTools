...
const float h = 0.064;    // h  - sampling interval

const controller_t activeController = BANG2;
...
const float Kp = 40;       // Kp - proportional constant
