...
*
* For the PID implementation, see: https://aleksandarhaber.com/pid-controller-discretization-and-implementation-in-arduino/
*/

#include "controller.h"

const float h = 0.032;    // h  - sampling interval
...
float Td = 0.0;     // Td - differential time

const float max_u = 10;  // max_u - saturation value for control signal

/* hysteresis for bang-bang controller */
const float deltah=0.5;

/* value for bang-bang control */
const float bangvalue = 1.25;
